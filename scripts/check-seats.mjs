...
assert.equal(sleep.capacity, 55);
assert.throws(
  () =>
...
console.log(
  '55 places; atomic bed rest/wake, sleeping privacy, shared gestures, cooldown/expiry, IP identity, capacity and HTTP boundaries passed.',
);
