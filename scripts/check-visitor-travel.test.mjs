...
void test('all 55 seats connect through safe sampled floor paths with continuous rise, walk and settle', () => {
  assert.equal(Object.keys(visitorTravelNodes).length, 55);
  assert.equal(Object.keys(routes.routes).length, 1485);
