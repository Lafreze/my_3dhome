...
export const newObjects = {
  ...
  livingWindow: { name: '客厅窗', kind: 'ATMOSPHERE', action: '时间与天气' },
  ...
  bedroomWindow: { name: '卧室窗', kind: 'ATMOSPHERE', action: '时间与天气' },
  ...
  galleryWindow: { name: '展厅窗', kind: 'ATMOSPHERE', action: '时间与天气' },
} as const;
